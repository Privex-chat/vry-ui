...
NUMBERTORANKS = [
            ...
            color('Brnz 1', fore=(187, 143, 90)),
            color('Brnz 2', fore=(187, 143, 90)),
            color('Brnz 3', fore=(187, 143, 90)),
            ...
            color('As 3', fore=(24, 148, 82)),
            color('Immo 1', fore=(221, 68, 68)),
            color('Immo 2', fore=(221, 68, 68)),
            color('Immo 3', fore=(221, 68, 68)),
...
THEMES = {
    "dark": Theme(
        "dark", 
        "#1e1e1e", "#fff", "#444", "#2b2b2b", "#3d3d3d", "#2b2b2b"
    ),
    "light": Theme(
        "light",
        "#f5f5f5", "#333", "#ddd", "#e8e8e8", "#d0e3ff", "#e0e0e0"
    )
}